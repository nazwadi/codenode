...
<div class="profile left">
    {{ form('account/profile', 'id': 'profileForm', 'onbeforesubmit': 'return false') }}
        <div class="clearfix">
            <label for="name">Your Full Name:</label>
            <div class="input">
                {{ text_field("name", "size": "30", "class": "col-sm6 col-md6") }}
        ...
        <div class="clearfix">
            ...
            <div class="input">
                {{ text_field("email", "size": "30", "class": "sm6 md6") }}
        ...
        <div class="clearfix">
            ...
            &nbsp;
            {{ link_to('challenges/index', 'Cancel') }}
        </div>
    </form>
