    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <div id="challengeMenu">
                ...
                {% for track in tracks %}
                    <a href="#{{ track.uri_name }}" class="list-group-item list-group-item-info strong" data-toggle="collapse" data-parent="#challengeMenu"> <span class="glyphicon glyphicon-plus"> {{ track.name }} </span><i class="fa fa-caret-down"></i></a>
                    <div class="collapse" id="{{ track.uri_name }}">
                    {% for category in categories[track.id] %}
                        <a href="/challenges/index/{{ track.uri_name }}/{{category.uri_name}}" class="list-group-item">{{ category.name }}</a>
                    {% endfor %}
                    </div>
                {% endfor %}
                </div>
        ...
        <div class="col-sm-9">
            ...
            <ol class="breadcrumb">
                <li>Challenges</li>
                <li><a href="#">{{ current_track.name }}</a></li>
                <li><a href="#">{{ current_category.name }}</a></li>
            </ol>
